...
//document.write("<ul class='bodystyle'>");
...
//document.write("<li id='ystyle' class='mm'>"+md(mr.Myear)+' ခုနှစ်'+"</li>");
//document.write("<li id='mstyle' class='mm'>"+mr.MMonth+"</li>");
//document.write("<li id='date' class='mm'>"+mr.HMonth);
//document.write((mr.Mday!=15?" "+md(mr.Mday)+' ရက်':"</li>"));
//document.write("<li id='wd' class='mm'>"+weekday[d.getDay()]+"</li>");
//Print Special Day
...
//document.write("<style type='text/css'>li.special.mm{display:none;}</style>");
return;
}
var now=new Date();

//document.write("<li class='special mm'>"+specialday(now.getMonth(),now.getDate())+"</li>");
//document.write("</ul>");